...
# Create CloudWatch alarms that are triggered from events streaming from CloudTrail.
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
# --------------------------------------------------------------------------------------------------
# CREATE THE SNS TOPIC TO WHICH ALARMS WILL BE FORWARDED
# --------------------------------------------------------------------------------------------------
...
# Create an SNS topic policy that allows the CloudWatch alarms in each of the org accounts to send
# alarm details to this SNS topic (typically only deployed in the audit account).
# --------------------------------------------------------------------------------------------------
...
data "aws_iam_policy_document" "sns_topic_policy" {
  statement {
    sid    = "AllowCloudWatchAlarmsSnsPublishAccess"
    effect = "Allow"
...
# ----------------------------------------------------------------------------------------------------------------------
# CREATE THE CLOUDWATCH LOG GROUP WHERE CLOUDTRAIL EVENTS WILL BE SENT
# ----------------------------------------------------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------------------------------------------------
# CREATE CLOUDWATCH ALARMS TO MONITOR GRC CONTROLS
# ----------------------------------------------------------------------------------------------------------------------
